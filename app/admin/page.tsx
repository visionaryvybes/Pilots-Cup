...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === 'admin@pilotscup.ae' && password === 'admin123') {
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <div className="relative h-20 w-20">
            <div className="absolute inset-0 bg-red-600 rounded-full flex items-center justify-center text-white font-bold text-xl">PC</div>
          </div>
        </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-gray-600">
                If you need access to the admin dashboard, please contact the system administrator.
              </p>
            </div>
          </div>
        </div>
